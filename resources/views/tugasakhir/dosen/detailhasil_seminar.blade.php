...
<div class="page-content">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb default square rsaquo sm">
            ...
            <li class="active">Hasil Ujian Seminar</li>
        </ol>


        <h3 class="page-heading">Hasil Ujian Seminar</h3>
        <!-- BEGIN DATA TABLE -->
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="the-box">
                    <fieldset>
                        <form action="{{url('dsn/detailhasil_seminarpost/')}}" method="post"
                            ...
                            <div class="form-group">
                                <div class="col-xs-12" align="right">
                                    <button id="tombol_satu" class="btn btn-info btn-perspective" type="button"
                                        ...
                                        data-formaction="{{url('dsn/detailhasil_seminarpost/')}}"

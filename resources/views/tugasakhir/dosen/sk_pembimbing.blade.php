...
@section('isi')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <h3 class="page-heading">Daftar Riwayat SK Pembimbing</h3>
            ...
            <div class="the-box">
                <div class="table-responsive">
                    <form method="post" action="{{ url('dsn/cetakskpembimbing') }}" target="_blank">
                        {{ csrf_field() }}
                            ...
                            <tbody>
                                @foreach ($data_sk as $key => $value)
                                    <tr class="odd gradeX">
                                        ...
                                        <td>{{ isset($value->pembimbing_I_id) ? helper::getDeskripsi($value->pembimbing_I_id) : '' }}
                                        </td>
                                        <td>{{ isset($value->pembimbing_II_id) ? helper::getDeskripsi($value->pembimbing_II_id) : '' }}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <button
                                                class="btn btn-primary fa fa-paperclip btn-perspective"
                                                name="nomor"
                                                value="{{ $value->nomor_sk }}"
                                                type="submit">
                                            </button>
                                        </td>
                                    </tr>

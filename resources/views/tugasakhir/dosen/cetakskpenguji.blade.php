...
<html lang="{{app()->getLocale()}}">
    ...
    <body>
        ...
        <br>
        <p align="justify">
        Sesuai Peraturan akademik pada Program Studi {{helper::getProgramStudiByNim($nim)}} Fakultas Hukum Universitas Muslim Indonesia dengan ini menetapkan tim penguji atau penanggap pada ujian {{strtolower($tipe_ujian)}}, maka
        </p>

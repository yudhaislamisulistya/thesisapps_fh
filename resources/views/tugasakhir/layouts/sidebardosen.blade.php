...
<div class="sidebar-left sidebar-nicescroller">
    <ul class="sidebar-menu">
        ...
        <li>
            <a href="{{ route('get_dosen_sk_pembimbing') }}">
        ...
        <li>
            ...
            <ul class="submenu">
                ...
                <li><a href="{{ url('dsn/jadwal_seminar') }}">Seminar</a></li>
    ...
    <div class="tab-content">
        <div class="tab-pane fade in active" id="online-user-sidebar">
            <ul class="sidebar-menu online-user">
                ...
                <li><a href="#fakelink">
                        <span class="user-status success"></span>
                        <img src="{{ asset('master/assets/img/avatar/avatar-5.jpg') }}"
                ...
                <li><a href="#fakelink">
                        <span class="user-status success"></span>
                        <img src="{{ asset('master/assets/img/avatar/avatar-6.jpg') }}"
                            class="ava-sidebar img-circle" alt="Avatar">
                ...
                <li><a href="#fakelink">
                        ...
                        <img src="{{ asset('master/assets/img/avatar/avatar-7.jpg') }}"
                            class="ava-sidebar img-circle" alt="Avatar">

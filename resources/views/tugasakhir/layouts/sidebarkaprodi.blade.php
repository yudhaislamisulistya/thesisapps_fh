            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <a style="display: inline-block; width: 30px; padding: 0px; height: 30px; color: white; line-height: 2.3; border-radius: 5px;"
                        href="{{url('prodi/ubah_password')}}" class="btn btn-success btn-xs"><i
                            class="fa fa-cog"></i></a>
    ...
    <div class="tab-content">
        <div class="tab-pane fade in active" id="online-user-sidebar">
            <ul class="sidebar-menu online-user">
                ...
                <li><a href="#fakelink">
                        <span class="user-status warning"></span>
                        <img src="{{ asset('master/assets/img/avatar/avatar-9.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                        Mya Weastell
                ...
                <li><a href="#fakelink">
                        <span class="user-status warning"></span>
                        <img src="{{ asset('master/assets/img/avatar/avatar-10.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                        <i class="fa fa-mobile-phone device-status"></i>
                        Carl Rodriguez
                ...
                <li><a href="#fakelink">
                        <span class="user-status warning"></span>
                        <img src="{{ asset('master/assets/img/avatar/avatar-11.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                        <i class="fa fa-mobile-phone device-status"></i>
                        Nikita Carter
                ...
                <li><a href="#fakelink">
                        ...
                        <img src="{{ asset('master/assets/img/avatar/avatar-12.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                        Craig Dixon
                ...
                <li><a href="#fakelink">
                        <span class="user-status danger"></span>
                        <img src="{{ asset('master/assets/img/avatar/avatar-13.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                        Mikayla King
                ...
                <li><a href="#fakelink">
                        <span class="user-status danger"></span>
                        <img src="{{ asset('master/assets/img/avatar/avatar-14.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                        Richard Dixon
                ...
                <li><a href="#fakelink">
                        <span class="user-status danger"></span>
                        <img src="{{ asset('master/assets/img/avatar/avatar-15.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                        Brenda Fuller
                ...
                <li><a href="#fakelink">
                        <span class="user-status danger"></span>
                        <img src="{{ asset('master/assets/img/avatar/avatar-16.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                        Ryan Ortega
        ...
        <div class="tab-pane fade" id="notification-sidebar">
            <ul class="sidebar-menu sidebar-notification">
                ...
                <li><a href="#fakelink" data-toggle="tooltip" title="Karen Wallace" data-placement="left">
                        <img src="{{ asset('master/assets/img/avatar/avatar-25.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                ...
                <li><a href="#fakelink" data-toggle="tooltip" title="Phillip Lucas" data-placement="left">
                        <img src="{{ asset('master/assets/img/avatar/avatar-24.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                ...
                <li><a href="#fakelink" data-toggle="tooltip" title="Sandra Myers" data-placement="left">
                        <img src="{{ asset('master/assets/img/avatar/avatar-23.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                ...
                <li><a href="#fakelink" data-toggle="tooltip" title="Charles Guerrero" data-placement="left">
                        <img src="{{ asset('master/assets/img/avatar/avatar-22.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                ...
                <li><a href="#fakelink" data-toggle="tooltip" title="Maria Simpson" data-placement="left">
                        <img src="{{ asset('master/assets/img/avatar/avatar-21.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                ...
                <li><a href="#fakelink" data-toggle="tooltip" title="Jason Crawford" data-placement="left">
                        <img src="{{ asset('master/assets/img/avatar/avatar-20.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                        <span class="activity">Posted something on your profile page</span>
                ...
                <li><a href="#fakelink" data-toggle="tooltip" title="Cynthia Mendez" data-placement="left">
                        <img src="{{ asset('master/assets/img/avatar/avatar-19.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                        <span class="activity">Uploaded a photo</span>
                ...
                <li><a href="#fakelink" data-toggle="tooltip" title="Peter Ramirez" data-placement="left">
                        <img src="{{ asset('master/assets/img/avatar/avatar-18.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                        <span class="activity">Commented on your post</span>
                ...
                <li><a href="#fakelink" data-toggle="tooltip" title="Jessica Gutierrez" data-placement="left">
                        <img src="{{ asset('master/assets/img/avatar/avatar-17.jpg')}}" class="ava-sidebar img-circle"
                            alt="Avatar">
                        <span class="activity">Send you a message</span>
        ...
        <div class="tab-pane fade" id="setting-sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="text-content">
                    <div class="switch">
                        <div class="onoffswitch blank">
                            <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="offlinecontact"
                                checked>
                ...
                <li class="text-content">
                    <div class="switch">
                        <div class="onoffswitch blank">
                            <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="personalstatus"
                                checked>

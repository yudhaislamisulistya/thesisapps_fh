        ...
        <li class="static left-profile-summary">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <a style="display: inline-block; width: 30px; padding: 0px; height: 30px; color: white; line-height: 2.3; border-radius: 5px;" href="{{url('wakildekan/ubah_password')}}" class="btn btn-success btn-xs"><i class="fa fa-cog"></i></a>

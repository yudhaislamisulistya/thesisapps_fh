    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb default square rsaquo sm">
                ...
                <li><a href="{{ url('/wakildekan/topik') }}">Topik Usulan</a></li>
            ...
            <div class="the-box">
                ...
                <div class="table-responsive">
                    <form method="post" action="{{ url('wakildekan/topik') }}">
                        {{ csrf_field() }}
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a class="btn btn-info"
                                                href="{{ url('wakildekan/detail_note') }}/{{ $value->topik_id }}"><i
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-danger" onclick="showModal(this)"
                                                data-href="{{ url('wakildekan/tolak_topik_penelitian') }}/{{ $value->topik_id }}"
                        ...
                        <p align="right">
                            <button id="tombol_satu" class="btn btn-danger btn-perspective" type="button"
                                onclick="showPostModal(this)" data-formaction="{{ url('wakildekan/topik') }}"

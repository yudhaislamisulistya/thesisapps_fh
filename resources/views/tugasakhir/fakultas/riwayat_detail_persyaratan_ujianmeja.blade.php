                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        @elseif (auth()->user()->name == 'akademikfakultasfh')
                                            <a class="btn btn-info"
                                                href="{{ url('fakultas/detail_persyaratan_ujianmeja/catatan') }}/{{ $trtsyaratujian->id }}/{{ $mhs->C_NPM }}"><i
                                                    class="fa fa-newspaper-o"></i></a>
                                        @else
                                            <a class="btn btn-info"
                                                href="{{ url('prodi/detail_persyaratan_ujianmeja/catatan') }}/{{ $trtsyaratujian->id }}/{{ $mhs->C_NPM }}"><i
                                                    class="fa fa-newspaper-o"></i></a>
                                        @endif
                                    </td>
                                </tr>

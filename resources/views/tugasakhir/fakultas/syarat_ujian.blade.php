...
@section('isi')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- BEGIN DATA TABLE -->
            <div class="the-box">
                <form method="post" action="{{ url('fakultas/syaratadd') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-xs-7" align="right">
                                <button class="btn btn-primary btn-perspective" type="button" onclick="showPostModal(this)"
                                    data-formaction="{{ url('fakultas/syaratadd') }}" data-target="#modalPrimary"
            ...
            <!-- END DATA TABLE -->
            <h3 class="page-heading">Daftar Syarat Seminar</h3>
            <!-- BEGIN DATA TABLE -->
            <div class="the-box">
                <div class="table-responsive">
                    <table class="table table-striped table-hover" id="">

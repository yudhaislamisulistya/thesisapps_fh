    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb default square rsaquo sm">
                <li><a href="index.html"><i class="fa fa-home"></i></li>
            ...
            <!-- BEGIN DATA TABLE -->
            <div class="the-box">
                <form method="post" action="{{ url('fakultas/surat_pengusulan') }}" target="_blank">
                    {{ csrf_field() }}
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-xs-8" align="right">
                                <a href="{{ url('fakultas/surat_usulan_pembimbing') }}" class="btn btn-danger btn-perspective">Batal</a>
                                <button id="tombol_satu" class="btn btn-primary btn-perspective" type="button" onclick="showPostModal(this)" data-target="#modalPrimary" data-toggle="modal" data-formaction="{{ url('fakultas/surat_pengusulan') }}">Simpan dan Cetak</button>
                            </div>
                        </div>
                    </fieldset>
                </form>
...
@section("modalPrimaryFooter")
    <button onclick="submitFormAndRedirect()" id="tombol_dua" class="btn btn-default">Simpan</button>
@endsection
@section("script")
    <script>

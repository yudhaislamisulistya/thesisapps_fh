...
<div class="title">
    ...
    <div class="title">
        ...
        <h4 class="headingTitle">Nomor : {{helper::getNomorSkPerMhsFromTrtPengujiSeminar($nim)}}</h4></u>
    </div>
    <br>
    <p align="justify">
        Sesuai Peraturan akademik pada Program Studi {{helper::getProgramStudiByNim($nim)}} Fakultas Hukum

...
@section('isi')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- BEGIN DATA TABLE -->
            <div class="the-box">
                <form method="post" action="{{ url('fakultas/jadwal') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" class="form-control datepicker bold-border"
                                    data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" name="tgl_start">
                            </div>
                        </div>
                        <br><br>
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" class="form-control datepicker bold-border"
                                    data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" name="tgl_end">
                            </div>
                        </div>
                        <br><br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-xs-7" align="right">
                                <button id="tombol_satu" class="btn btn-primary btn-perspective" type="button"
                                    onclick="showPostModal(this)" data-formaction="{{ url('fakultas/jadwal') }}"
                        ...
                        <tbody>
                            @foreach ($pendaftaran as $key => $value)
                                <tr class="odd gradeX">
                                    ...
                                    @php
                                        $countname = \App\Model\mst_pendaftaran::where(
                                            'nama_periode',
                                            $value->nama_periode,
                                        )->count();
                                    @endphp
                                    ...
                                    <td>
                                        <a href="{{ url('fakultas/temp_daftar_peserta') }}/{{ $value->pendaftaran_id }}"><i
                                    ...
                                    <td>
                                        <button class="btn btn-danger" onclick="showModal(this)" data-target="#modalDanger"
                                            data-toggle="modal"
                                            data-href="{{ url('fakultas/pendaftarandel/' . $value->pendaftaran_id) }}"><i
            ...
            <!-- BEGIN DATA TABLE -->
            <div class="the-box">
                <form action="{{ url('/fakultas/jadwalujian') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <fieldset>
                        <br><br>
                        <div class="form-group">
                            ...
                            <div class="col-xs-5">
                                @php
                                    if (Auth::user()->name == 'akademikfakultasfh') {
                                        $mstpendaftaran = Illuminate\Database\Eloquent\Collection::make(
                                            \App\Model\mst_pendaftaran::whereNotIn(
                                                'pendaftaran_id',
                                                \App\TrtJadwalUjian::select('pendaftaran_id'),
                                            )
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" class="form-control datepicker bold-border"
                                    data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" name="tgl_ujian" required>
                            </div>
                        </div>
                        <br><br>
                        <div class="form-group">
                            <div class="col-xs-7" align="right">
                                <button id="tombol_tiga" type="button" onclick="showPostModal(this)"
                                    data-target="#modalPrimary" data-toggle="modal"
                                    data-formaction="{{ url('/fakultas/jadwalujian') }}"
                        ...
                        <tbody>
                            @foreach ($jadwalujian as $i => $d)
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="{{ url('fakultas/daftar_peserta/' . $d->pendaftaran_id) }}"><i
                                    ...
                                    <td>
                                        <button class="btn btn-danger" onclick="showModal(this)"
                                            ...
                                            data-href="{{ url("fakultas/jadwalujiandel/$d->pendaftaran_id") }}"><i
                                                class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                            @endforeach

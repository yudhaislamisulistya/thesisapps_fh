    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb default square rsaquo sm">
                ...
                <li><a href="{{ url('/fakultas/usulan_pembimbing')}}">Set Penguji</a></li>
            ...
            <!-- BEGIN DATA TABLE -->
            <div class="the-box">
                <form method="post" action="{{url('fakultas/set_jadwalpermhs/'.$pendaftaran_id)}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-xs-7" align="right">
                                <button id="tombol_satu" class="btn btn-danger btn-perspective" type="button" onclick="showPostModal(this)" data-formaction="{{url('fakultas/set_jadwalpermhs/'.$pendaftaran_id)}}" data-target="#modalPrimary" data-toggle="modal">Simpan</button>
                            </div>
                        </div>
                    </fieldset>
                </form>

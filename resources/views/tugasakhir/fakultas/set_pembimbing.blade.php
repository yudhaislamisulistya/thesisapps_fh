    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb default square rsaquo sm">
                ...
                <li><a href="{{ url('/fakultas/usulan_pembimbing') }}">Usulan Pembimbing</a></li>
            ...
            <!-- BEGIN DATA TABLE -->
            <div class="the-box">
                <form method="post" action="{{ url('fakultas/usulan_pembimbing') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <fieldset>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">NIM</label>
                            <div class="col-lg-5">
                                <input id="nim" type="hidden" class="form-control bold-border" name="C_NPM"
                                    value="{{ $data_mahasiswa->C_NPM }}" />
                                <input type="text" class="form-control bold-border" name="nim"
                                    value="{{ $data_mahasiswa->C_NPM }}" disabled />
                            </div>
                        </div>
                        <br><br>
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" class="form-control bold-border" name="nama"
                                    value="{{ $data_mahasiswa->NAMA_MAHASISWA }}" disabled />
                            </div>
                        </div>
                        <br><br>
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" class="form-control bold-border" name="judul"
                                    value="{{ $data_topik->topik }}" readonly/>
                            </div>
                        </div>
                        <br><br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-xs-7" align="right">
                                <button
                                    class="btn btn-primary btn-perspective"
                                    type="button"
                                    onclick="showPostModal(this)"
                                    data-target="#modalPrimary"
                                    data-toggle="modal"
                                    data-formaction="{{ url('fakultas/usulan_pembimbing') }}">
                                    Simpan dan Buat SK
                                </button>
                            </div>
                        </div>
...
@section('script')
    <script>
        $('#tombol_simpan_sementara').on('click', function() {
            ...
            axios.get(
                    `https://thesis-dev.fikom.app/fh/api/simpan_sementara_set_pembimbing/${nim}/${pembimbing1}/${pembimbing2}`
                )
                .then(res => {
                    ...
                    if (res.data == 'berhasil') {
                        Swal.fire({
                            ...
                            window.location =
                                "https://thesis-dev.fikom.app/fh/fakultas/usulan_pembimbing";
                        });
                    } else {
                        Swal.fire({
                            title: "Status!",
        ...
        const initStatusPembimbing = e => {
            ...
            axios.get(
                    `https://thesis-dev.fikom.app/fh/fakultas/usulan_tmp/pembimbing/getstatus/${index}/${id}/{{ $data_mahasiswa->C_NPM }}`
                )
                .then(res => {
                    if (index === "0") {
                        status.map(s => {

...
<div class="page-content">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb default square rsaquo sm">
            ...
            <li class="active">SK Ujian Seminar</li>
        </ol>
        <!-- End breadcrumb -->

        <!-- BEGIN DATA TABLE -->
        <h3 class="page-heading">Penetapan Nomor SK Ujian Seminar</h3>
            ...
            <div class="table-responsive">
                <table class="table table-th-block">
                    ...
                    @foreach($data as $key => $value)
                        <form method="post" action="{{url("fakultas/add_sk_pembimbing_seminar")}}">
                            {{ csrf_field() }}
                    <tr class="odd gradeX">
                        ...
                        <td>{{$value->judul}}</td>
                        <td>
                            <input required type="text" class="form-control bold-border" name="nomor_sk" value="{{isset($value->bimbingan_id) ? helper::getNomorSkPerMhsFromTrtPengujiSeminar($value->C_NPM) :'' }}"/>

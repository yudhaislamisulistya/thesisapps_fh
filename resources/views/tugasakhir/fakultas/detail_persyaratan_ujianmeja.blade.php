...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- BEGIN DATA TABLE -->
        <h3 class="page-heading">Detail Pengajuan Persyaratan Ujian Meja</h3>
        ...
        <div class="the-box">
            ...
            <div class="row text-left">
                <div class="col-sm-6">
                    ...
                    <button data-href="{{url("/akademikprodi/selesai_konfirmasi/$mhs->C_NPM/2")}}"
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                <a class="btn btn-info"
                                    href="{{url('akademikprodi/detail_persyaratan_ujianmeja/catatan')}}/{{$trtsyaratujian->id}}/{{$mhs->C_NPM}}"><i
                                        class="fa fa-newspaper-o"></i></a>
                                @else
                                <a class="btn btn-info" href="{{url('prodi/detail_persyaratan_ujianmeja/catatan')}}/{{$trtsyaratujian->id}}/{{$mhs->C_NPM}}"><i
                                        class="fa fa-newspaper-o"></i></a>
                                @endif
                            </td>
                        </tr>

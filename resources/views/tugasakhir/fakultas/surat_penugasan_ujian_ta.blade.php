...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- BEGIN DATA TABLE -->
        <h3 class="page-heading">Daftar Surat Usulan Tim Ujian TA</h3>
        <div class="the-box">
            <div class="table-responsive">
                <form method="post" action="{{url('fakultas/sk_penetapan_tim_ujian_ta')}}" target="_blank">
                    {{ csrf_field() }}
                <table class="table table-striped table-hover" id="datatable-example">
                    <thead class="the-box dark full">
                    <tr>
                    ...
                    <tbody>
                    @foreach($daftar_surat_usulan as $key => $value)
                    <tr class="odd gradeX">
                        <td width="1%" align="center">{{++$key}}</td>
                        <td>{{$value->nomor}}</td>

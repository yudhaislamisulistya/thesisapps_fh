...
@section('isi')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="the-box">
                <a href="{{url('fakultas/approve_hasilujian_proposal_all_post/')}}" class="btn btn-info mb-5" style="margin-bottom: 20px">Konfirmasi Semua</a>
                    ...
                    <table class="table table-striped table-hover" id="datatable-example">
                        ...
                        @foreach($data as $key => $value)
                            <tr class="odd gradeX">
                                ...
                                <td><a href="{{ url('fakultas/detail_hasilujian_proposal/'.$value->pendaftaran_id)}}"><i class="fa fa-copy icon-square icon-xs icon-primary"></i></a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>

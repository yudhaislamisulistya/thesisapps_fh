                        ...
                        <tbody>
                            <tr class="odd gradeX">
                                ...
                                @if (helper::getStatusSKPembimbingForMahasiswa(auth()->user()->name) != '')
                                    <td><a target="_blank"
                                            href="{{ url('mhs/surat_sk_pembimbing') }}/{{ str_replace('/', '', helper::getStatusSKPembimbingForMahasiswa(auth()->user()->name)->nomor_sk) }}"><i
                            ...
                            <tr class="odd gradeX">
                                ...
                                @if (helper::getStatusSKUjianProposalForMahasiswa(auth()->user()->name) != '')
                                    <td><a target="_blank"
                                            href="{{ url('mhs/surat_sk_proposal') }}/{{ helper::getPendaftaranIdForMahasiswa(0) }}"><i
                                                class="fa fa-paperclip icon-square icon-xs icon-dark"></i></a></td>
                                @else
                            ...
                            <tr class="odd gradeX">
                                ...
                                @if (helper::getStatusSKUjianSeminarForMahasiswa(auth()->user()->name) != '')
                                    <td><a target="_blank"
                                            href="{{ url('mhs/surat_sk_seminar') }}/{{ helper::getPendaftaranIdForMahasiswa(1) }}"><i
                                                class="fa fa-paperclip icon-square icon-xs icon-dark"></i></a></td>
                                @else
                            ...
                            <tr class="odd gradeX">
                                ...
                                @if (helper::getStatusSKUjianMejaForMahasiswa(auth()->user()->name) != '')
                                    <td><a target="_blank"
                                            href="{{ url('mhs/surat_sk_ujian_meja') }}/{{ str_replace('/', '', helper::getStatusSKUjianMejaForMahasiswa(auth()->user()->name)->nomor_sk) }}"><i
                                                class="fa fa-paperclip icon-square icon-xs icon-dark"></i></a></td>
                                @else
                            ...
                            <tr class="odd gradeX">
                                <td width="1%" align="center">1</td>
                                <td>Dokumen Persetujuan Judul</td>
                                @if (helper::getStatusSKPembimbingForMahasiswa(auth()->user()->name) != '')
                                    <td><a target="_blank"
                                            href="{{ url('mhs/surat_pengusulan') }}/{{ str_replace('/', '$', helper::getStatusSKPembimbingForMahasiswaByTrtSk(auth()->user()->name)->nomor) }}"><i
                                                class="fa fa-paperclip icon-square icon-xs icon-dark"></i></a></td>
                                @else
                                    <td><span class="badge badge-danger">Dokumen Persetujuan Judul Belum Ada</span></td>
                                @endif
                            </tr>
                            @foreach ($data as $key => $value)
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="{{ $value->link_download }}" target="_blank"><i
                                                class="fa fa-paperclip icon-square icon-xs icon-dark"></i></a></td>
                                </tr>
                            @endforeach
                        </tbody>

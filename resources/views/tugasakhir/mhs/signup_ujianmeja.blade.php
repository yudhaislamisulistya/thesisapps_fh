                ...
                <div class="the-box">
                    <div class="table-responsive">
                        ...
                        <table class="table table-th-block">
                            ...
                            <tbody>
                                @php
                                    $mstsyaratujian = \App\Model\mst_syarat_ujian::where(['tipe_ujian' => 2])->count();
                                    $trtsyaratujian = \App\TrtSyaratUjian::where([
                                        ...
                                        ->whereIn(
                                            'syarat_ujian_id',
                                            \App\Model\mst_syarat_ujian::where(['tipe_ujian' => 2])->select(
                                                'syarat_ujian_id',
                                            ),
                                        )
                                        ->count();
                                    ...
                                    $trtreg = \App\Model\trt_reg::whereIn(
                                        ...
                                        ->whereIn(
                                            'pendaftaran_id',
                                            \App\Model\mst_pendaftaran::where('tipe_ujian', 2)->select(
                                                'pendaftaran_id',
                                            ),
                                        )
                                        ->count();
                ...
                <div style="display: flex">
                    @php
                        $trtsyaratujianx = \App\TrtSyaratUjian::where('C_NPM', auth()->user()->name)
                            ->whereIn(
                                'syarat_ujian_id',
                                \App\Model\mst_syarat_ujian::where('tipe_ujian', 2)->select('syarat_ujian_id'),
                            )
                            ->count();

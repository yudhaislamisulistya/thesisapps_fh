            ...
            <div class="the-box">
                <fieldset>
                    ...
                    @php
                        ...
                        } elseif ($data[0]->tipe_ujian == 1) {
                            $nama_tipe_ujian = 'Seminar';
                        ...
                        <div class="col-lg-6">
                            @php
                                if ($data_count_nilai == 0) {
                                    ...
                                    $nilai_final =
                                        (helper::getTotalNilaByNidnAndRegId(
                                            $data[0]->pembimbing_I_id,
                                            $data[0]->reg_id,
                                        ) +
                                            helper::getTotalNilaByNidnAndRegId(
                                                $data[0]->pembimbing_II_id,
                                                $data[0]->reg_id,
                                            ) +
                                            helper::getTotalNilaByNidnAndRegId(
                                                $data[0]->penguji_I_id,
                                            ...
                                            helper::getTotalNilaByNidnAndRegId(
                                                $data[0]->penguji_II_id,
                                                $data[0]->reg_id,
                                            ) +
                                            helper::getTotalNilaByNidnAndRegId(
                                                $data[0]->penguji_III_id,
                                                $data[0]->reg_id,
                                            ) +
                                            helper::getTotalNilaByNidnAndRegId(
                                                $data[0]->ketua_sidang_id,
                                                $data[0]->reg_id,
                                            )) /
                                        $data_count_nilai;
                                }
                            ...
                            @if ($nilai_final > 85)
                                @php
                                    $index_nilai = 'A';
                                @endphp
                            @elseif($nilai_final >= 81 && $nilai_final <= 85)
                                @php $index_nilai="A-" ; @endphp
                            @elseif($nilai_final >= 76 && $nilai_final <= 80)
                                @php $index_nilai="B+" ; @endphp
                            @elseif($nilai_final >= 71 && $nilai_final <= 75)
                                @php $index_nilai="B" ; @endphp
                            @endif <input type="text" class="form-control bold-border"
                                name="tipe_ujian" disabled value="{{ $index_nilai }}" />
                        </div>
                    </div>
                    <br><br>
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <span style="font-size: 12px"><i>Sumber: Peraturan No. 1 Tahun 2014 UMI Tentang
                                            Ketentuan Pokok Akademik Pasal 43 Predikat Kelulusan</i></span>
                                </div>
                                    ...
                                    <tr>
                                        ...
                                        @if (Auth::user()->level == 7 || Auth::user()->level == 6 || Auth::user()->level == 4)
                                            ...
                                            @else
                                                ...
                                                @elseif($data[0]->tipe_ujian == 1)
                                                    <td><a target="_blank"
                                                            href="{{ url('dsn/detailhasil_seminarhasil/') }}/{{ $data[0]->ketua_sidang_id }}/{{ $data[0]->reg_id }}/{{ $data[0]->pendaftaran_id }}/{{ $data[0]->C_NPM }}/1"
                                                            class="btn btn-info"><i
                                                                class="fa fa-file-text"></i>Penilaian</a></td>
                                                @elseif($data[0]->tipe_ujian == 2)
                                                    <td><a target="_blank"
                            ...
                            @if (helper::getTotalNilaByNidnAndRegId($data[0]->penguji_I_id, $data[0]->reg_id) == 0 ||
                                ...
                                <div class="form-group">
                                    <div class="col-xs-8" align="right">
                                        <a class="btn btn-info btn-perspective disabled" target="_blank">Belum Bisa
                                            Dicetak</a>
                                    </div>
                                </div>
                            @else

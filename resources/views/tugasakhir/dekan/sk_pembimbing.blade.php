                    ...
                    <table class="table table-striped table-hover" id="datatable-example">
                        ...
                        @foreach($data_sk as $key => $value)
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    @if (helper::getStatusApproveWakilDekan($value->sk_pembimbing_id) == 1)
                                        <a href="{{url('/dekan/appove_sk_pembimbing/')}}/{{$value->sk_pembimbing_id}}" class="btn btn-info fa fa-paperclip btn-perspective">Approve</a>
                                    @else

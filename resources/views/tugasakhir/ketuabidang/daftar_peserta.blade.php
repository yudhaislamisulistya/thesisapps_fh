                            ...
                            @foreach ($data as $i => $d)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <a href="{{ url("ketuabidang/set_penguji/$info->pendaftaran_id/$d->C_NPM/$info->tipe_ujian") }}"
                                                class="custom-link">
                                                <span class="custom-span">Menentukan Penguji</span>
                                            </a>
                                        @endif

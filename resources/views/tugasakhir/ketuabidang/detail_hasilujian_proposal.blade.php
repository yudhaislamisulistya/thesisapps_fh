                            ...
                            @foreach ($data as $i => $d)
                                <tr class="odd gradeX">
                                                ...
                                                @if (helper::getJumlahTrtHasil($d->reg_id) == 5)
                                                    @if (helper::getStatusTolakBimbinganProposalByNim($d->C_NPM) == 0)
                                                        <button onclick="showModal(this)" data-target="#modalPrimary"
                                                            data-toggle="modal"
                                                            data-href="{{ url('/ketuabidang/approve_hasilujian_proposal_post/') }}/{{ $d->bimbingan_id }}/{{ $d->C_NPM }}/{{ $d->pendaftaran_id }}"
                                                            class="btn btn-primary visible-lg-inline">Terima
                                                        </button>
                                                        <button onclick="showModal(this)" data-target="#modalDanger"
                                                            data-toggle="modal"
                                                            data-href="{{ url('/ketuabidang/tolak_hasilujian_proposal_post/') }}/{{ $d->bimbingan_id }}/{{ $d->C_NPM }}/{{ $d->pendaftaran_id }}"
                                    ...
                                    <td>
                                        ...
                                        @else
                                            @if (helper::getJumlahTrtHasil($d->reg_id) == 5)
                                                <a href="{{ url('ketuabidang/lembaran_hasilujian_proposal') }}/{{ $d->pendaftaran_id }}/{{ $d->C_NPM }}/{{ $d->reg_id }}"

    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb default square rsaquo sm">
                ...
                <li><a href="{{ url('/ketuabidang/usulan_pembimbing') }}">Set Penguji</a></li>
            ...
            <!-- BEGIN DATA TABLE -->
            <div class="the-box">
                <form method="post" action="{{ url('ketuabidang/set_penguji/' . $pendaftaran_id) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-xs-7" align="right">
                                <button id="tombol_satu" class="btn btn-danger btn-perspective" type="button"
                                    ...
                                    data-formaction="{{ url('ketuabidang/set_penguji/' . $pendaftaran_id) }}"

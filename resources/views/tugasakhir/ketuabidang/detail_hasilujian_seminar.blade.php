                            ...
                            @foreach ($data as $i => $d)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            @if (helper::getStatusBimbinganByNim($d->C_NPM) == 1)
                                                @if (helper::getJumlahTrtHasil($d->reg_id) == 5)
                                                    @if (helper::getStatusTolakBimbinganSeminarByNim($d->C_NPM) == 0)
                                                        <button onclick="showModal(this)" data-target="#modalPrimary"
                                                            data-toggle="modal"
                                                            data-href="{{ url('/fakultas/approve_hasilujian_seminar_post/') }}/{{ $d->bimbingan_id }}/{{ $d->C_NPM }}/{{ $d->pendaftaran_id }}"
                                                            class="btn btn-primary visible-lg-inline">Terima
                                                        </button>
                                                        <button onclick="showModal(this)" data-target="#modalDanger"
                                                            data-toggle="modal"
                                                            data-href="{{ url('/fakultas/tolak_hasilujian_seminar_post/') }}/{{ $d->bimbingan_id }}/{{ $d->C_NPM }}/{{ $d->pendaftaran_id }}"
                                    ...
                                    <td>
                                        ...
                                        @else
                                            @if (helper::getJumlahTrtHasil($d->reg_id) == 5)
                                                <a href="{{ url('fakultas/lembaran_hasilujian_seminar') }}/{{ $d->pendaftaran_id }}/{{ $d->C_NPM }}/{{ $d->reg_id }}"

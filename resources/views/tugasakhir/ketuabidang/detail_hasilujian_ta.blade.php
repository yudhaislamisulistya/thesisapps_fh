                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                                ...
                                @if (helper::getStatusBimbinganByNim($d->C_NPM) == 2)
                                    @if (helper::getJumlahTrtHasil($d->reg_id) == 5)
                                        @if (helper::getStatusTolakBimbinganMejaByNim($d->C_NPM) == 0)
                                            ...
                                            data-href="{{url('/fakultas/approve_hasilujian_ta_post/')}}/{{$d->bimbingan_id}}/{{$d->C_NPM}}/{{$d->pendaftaran_id}}"
                                            class="btn btn-primary">Terima
                                            </button>
                                            <button onclick="showModal(this)" data-target="#modalDanger" data-toggle="modal"
                                            data-href="{{url('/fakultas/tolak_hasilujian_ta_post/')}}/{{$d->bimbingan_id}}/{{$d->C_NPM}}/{{$d->pendaftaran_id}}"
                            ...
                            <td>
                                ...
                                @else
                                    @if (helper::getJumlahTrtHasil($d->reg_id) == 5)
                                        <a href="{{url('fakultas/lembaran_hasilujian_ta')}}/{{$d->pendaftaran_id}}/{{$d->C_NPM}}/{{$d->reg_id}}" class="btn btn-info" target="_blank"><i class="fa fa-paperclip"></i></a>
                                    @else

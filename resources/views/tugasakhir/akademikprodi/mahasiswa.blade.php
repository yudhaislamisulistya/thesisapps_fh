                    ...
                    <table class="table table-striped table-hover" id="datatable-example">
                        ...
                        @foreach ($data as $key => $value)
                            <tr class="odd gradeX">
                                ...
                                <td><a href="{{ url('akademikprodi/detail_mahasiswa/'.$value->C_NPM)}}"><i class="fa fa-copy icon-square icon-xs icon-primary"></i></a></td>
                                <td>
                                    <button onclick="showModal(this)" data-target="#modalPrimary" data-toggle="modal" title="Aktifasi Akun" class="btn btn-danger" data-href="{{ url('akademikprodi/make_user/'.$value->C_NPM)}}"><i class="fa fa-sign-in"></i></button>
                                    <button onclick="showModal(this)" data-target="#modalInfo" data-toggle="modal" title="Reset Akun" class="btn btn-default" data-href="{{ url('akademikprodi/reset_user/'.$value->C_NPM)}}"><i class="fa fa-recycle"></i></button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>

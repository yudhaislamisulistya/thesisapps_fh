    ...
    <div style="position: relative">
        <table style=" margin: 0 auto" border="1" width="550px" cellpadding="4" cellspacing="0">
            ...
            <tr>
                ...
                <td align="center">
                    {{helper::getNilaiKetuaSidangByDosen($data_dosen_selesai->ketua_sidang_id, $reg_id)->nilai_1}}</td>
            </tr>
            <tr>
                ...
                <td align="center">
                    {{helper::getNilaiKetuaSidangByDosen($data_dosen_selesai->ketua_sidang_id, $reg_id)->nilai_2}}</td>
            </tr>
            <tr>
                ...
                <td align="center">
                    {{helper::getNilaiKetuaSidangByDosen($data_dosen_selesai->ketua_sidang_id, $reg_id)->nilai_3}}</td>
            </tr>
            <tr>
                ...
                <td align="center">15 - 20</td>
                <td align="center">
                    {{helper::getNilaiKetuaSidangByDosen($data_dosen_selesai->ketua_sidang_id, $reg_id)->nilai_4}}</td>
            </tr>
            <tr>
                ...
                <td align="center">15 - 20</td>
                <td align="center">
                    {{helper::getNilaiKetuaSidangByDosen($data_dosen_selesai->ketua_sidang_id, $reg_id)->nilai_5}}</td>
            </tr>
            <tr>
    ...
    <div style="position: relative">
        <table style=" margin: 0 auto" border="1" width="550px" cellpadding="4" cellspacing="0">
            ...
            <tr>
                ...
                <td align="center">10 - 15</td>
                <td align="center">
                    {{helper::getNilaiKetuaSidangByDosen($data_dosen_selesai->penguji_III_id, $reg_id)->nilai_1}}</td>
            </tr>
            <tr>
                <td align="center">2</td>
                <td><b>Motivasi Penelitian</b><br>
                ...
                <td align="center">16 -25</td>
                <td align="center">
                    {{helper::getNilaiKetuaSidangByDosen($data_dosen_selesai->penguji_III_id, $reg_id)->nilai_2}}</td>
            </tr>
            <tr>
                <td align="center">3</td>
                <td><b>Motivasi Penelitian</b><br>
                ...
                <td align="center">15 - 20</td>
                <td align="center">
                    {{helper::getNilaiKetuaSidangByDosen($data_dosen_selesai->penguji_III_id, $reg_id)->nilai_3}}</td>
            </tr>
            <tr>
                <td align="center">4</td>
                <td><b>Metodologi</b><br>
                ...
                <td align="center">15 - 20</td>
                <td align="center">
                    {{helper::getNilaiKetuaSidangByDosen($data_dosen_selesai->penguji_III_id, $reg_id)->nilai_4}}</td>
            </tr>
            <tr>
                <td align="center">5</td>
                <td><b>Sistematika Penulisan</b><br>
                ...
                <td align="center">15 - 20</td>
                <td align="center">
                    {{helper::getNilaiKetuaSidangByDosen($data_dosen_selesai->penguji_III_id, $reg_id)->nilai_5}}</td>
            </tr>
            <tr>
                <td align="center" colspan="2" style="font-weight: bold">TOTAL NILAI</td>
                <td align="center" style="font-weight: bold">100%</td>

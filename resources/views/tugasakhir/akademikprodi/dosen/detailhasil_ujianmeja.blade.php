...
<div class="page-content">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb default square rsaquo sm">
            ...
            <li class="active">Hasil Ujian Meja</li>
        </ol>


        <h3 class="page-heading">Hasil Ujian Meja</h3>
        <!-- BEGIN DATA TABLE -->
        <div class="row">
            <div class="col-md-8">
                <div class="the-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <select id="nilai_1" class="form-control bold-border" name="nilai_1">
                                        ...
                                        @else
                                        <option value="{{str_replace(",",".",$nilai['nilai_1'])}}" selected>
                                            {{str_replace(",",".",$nilai['nilai_1'])}}</option>
                                        @endif
                                        @php
                                        $setelah_koma = 0;
                                        @endphp
                                        @for ($i = 6; $i <= 10; $i++) 
                                            ...
                                            @endphp 
                                            @if ($i==10) 
                                        @for ($j=1; $j < 2; $j++) <option value="{{$i}}.{{$setelah_koma}}">
                                            {{$i}}.{{$setelah_koma}}</option>
                                            @php
                                            $setelah_koma = 5;
                                            @endphp
                                            @endfor
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <select id="nilai_2" class="form-control bold-border" name="nilai_2">
                                        ...
                                        <option value="0" selected>--</option>
                                        @else
                                        <option value="{{str_replace(",",".",$nilai['nilai_2'])}}" selected>
                                            {{str_replace(",",".",$nilai['nilai_2'])}}</option>
                                        @endif
                                        @php
                                        $setelah_koma = 0;
                                        @endphp
                                        @for ($i = 10; $i <= 15; $i++) @php $setelah_koma=0; @endphp @if ($i==15) @for ($j=1; $j < 2; $j++) <option value="{{$i}}.{{$setelah_koma}}">
                                            {{$i}}.{{$setelah_koma}}</option>
                                            @php
                                            $setelah_koma = 5;
                                            @endphp
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <select id="nilai_3" class="form-control bold-border" name="nilai_3">
                                        ...
                                        <option value="0" selected>--</option>
                                        @else
                                        <option value="{{str_replace(",",".",$nilai['nilai_3'])}}" selected>
                                            {{str_replace(",",".",$nilai['nilai_3'])}}</option>
                                        @endif
                                        @php
                                        $setelah_koma = 0;
                                        @endphp
                                        @for ($i = 15; $i <= 20; $i++) @php $setelah_koma=0; @endphp @if ($i==20) @for ($j=1; $j < 2; $j++) <option value="{{$i}}.{{$setelah_koma}}">
                                            {{$i}}.{{$setelah_koma}}</option>
                                            @php
                                            $setelah_koma = 5;
                                            @endphp
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <select id="nilai_4" class="form-control bold-border" name="nilai_4">
                                        ...
                                        <option value="0" selected>--</option>
                                        @else
                                        <option value="{{str_replace(",",".",$nilai['nilai_4'])}}" selected>
                                            {{str_replace(",",".",$nilai['nilai_4'])}}</option>
                                        @endif

                                        @php
                                        $setelah_koma = 0;
                                        @endphp
                                        @for ($i = 20; $i <= 30; $i++) @php $setelah_koma=0; @endphp @if ($i==30) @for ($j=1; $j < 2; $j++) <option value="{{$i}}.{{$setelah_koma}}">
                                            {{$i}}.{{$setelah_koma}}</option>
                                            @php
                                            $setelah_koma = 5;
                                            @endphp
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <select id="nilai_5" class="form-control bold-border" name="nilai_5">
                                        ...
                                        <option value="0" selected>--</option>
                                        @else
                                        <option value="{{str_replace(",",".",$nilai['nilai_5'])}}" selected>
                                            {{str_replace(",",".",$nilai['nilai_5'])}}</option>
                                        @endif
                                        @php
                                        $setelah_koma = 0;
                                        @endphp
                                        @for ($i = 20; $i <= 25; $i++) @php $setelah_koma=0; @endphp @if ($i==25) @for ($j=1; $j < 2; $j++) <option value="{{$i}}.{{$setelah_koma}}">
                                            {{$i}}.{{$setelah_koma}}</option>
                                            @php
                                            $setelah_koma = 5;
                                            @endphp

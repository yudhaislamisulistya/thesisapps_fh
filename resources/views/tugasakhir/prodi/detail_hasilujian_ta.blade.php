                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                @if (helper::getStatusBimbinganByNim($d->C_NPM) == 2)
                                    @if (helper::getJumlahTrtHasil($d->reg_id) == 6)
                                        @if (helper::getStatusTolakBimbinganMejaByNim($d->C_NPM) == 0)
                                            ...
                                            data-href="{{url('/prodi/tolak_hasilujian_ta_post/')}}/{{$d->bimbingan_id}}/{{$d->C_NPM}}/{{$d->pendaftaran_id}}"
                            ...
                            <td>
                                ...
                                @else
                                    @if (helper::getJumlahTrtHasil($d->reg_id) == 6)
                                        <a href="{{url('prodi/lembaran_hasilujian_ta')}}/{{$d->pendaftaran_id}}/{{$d->C_NPM}}/{{$d->reg_id}}" class="btn btn-info" target="_blank"><i class="fa fa-paperclip"></i></a>
                                    @else

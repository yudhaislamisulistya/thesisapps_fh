                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-3">
                            <div class="list-group success square no-border">
                                <a href="{{ url('dsn/mail_inbox')}}" class="list-group-item">Pesan Masuk<span class="badge badge-success">{{helper::getDataPesanMasuk(auth()->user()->name)}}</span></a>
                                <a href="{{ url('dsn/mail_sent')}}" class="list-group-item active">Pesan Keluar<span class="badge badge-primary">{{helper::getDataPesanKeluar(auth()->user()->name)}}</span></a>
                            </div>
                        ...
                        <div class="col-sm-8 col-md-9">
                            ...
                            <div class="list-group success square no-side-border">
                                @foreach ($data as $key => $value)
                                    <a href="{{ url('dsn/mail_read/'.$value->pesan_id.'/2')}}" class="list-group-item mail-list">
                                        <input type="checkbox" class="i-grey-flat">
                                        <span class="name">{{ helper::getDeskripsi($value->penerima_id)}}{{ helper::getNamaMhs($value->penerima_id)}}</span>

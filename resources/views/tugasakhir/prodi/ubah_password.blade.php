...
<div class="page-content">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb default square rsaquo sm">
            ...
            <li><a href="{{ url('/prodi/ubah_password')}}"> Ubah Password</a></li>
        ...
        <div class="the-box">
            ...
            <form method="post" action="{{url('prodi/ubah_password')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <fieldset>
                    ...
                    <div class="form-group">
                        <div class="col-xs-7" align="right">
                            <button class="btn btn-primary btn-perspective" type="button" onclick="showPostModal(this)"
                                data-formaction="{{url('prodi/ubah_password/')}}" data-target="#modalPrimary"

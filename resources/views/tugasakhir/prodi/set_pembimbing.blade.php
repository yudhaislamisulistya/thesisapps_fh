...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- BEGIN DATA TABLE -->
        <div class="the-box">
            <form method="post" action="{{url('prodi/usulan_pembimbing')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <fieldset>
                    ...
                    <div class="form-group">
                        <div class="col-xs-7" align="right">
                            <a id="tombol_simpan_sementara" class="btn btn-info btn-perspective"><i
                                    class="fa fa-edit">Simpan Sementara</i></a>
                            <button class="btn btn-danger btn-perspective" type="button" onclick="showPostModal(this)"
                                ...
                                data-formaction="{{url('prodi/usulan_pembimbing')}}">Simpan</button>
                        </div>
                    </div>
                </fieldset>
            </form>
...
<script>
    ...
    const initStatusPembimbing = e => {
        ...
        axios.get(`https://thesis-dev.fikom.app/fh/prodi/usulan_tmp/pembimbing/getstatus/${index}/${id}/{{$data_mahasiswa->C_NPM}}`)
            .then(res => {
                if (index === "0") {
                    status.map(s => {
                        if (s.value === res.data) {

    ...
    <div class="container-fluid">
        ...
        <div class="the-box">
            @if (auth()->user()->name == "akademikproditi" || auth()->user()->name == "akademikprodisi" )
                <form method="post" action="{{url('akademikprodi/detail_persyaratan_proposal_catatan_post')}}" enctype="multipart/form-data">
            @else
                    <form method="post" action="{{url('prodi/detail_persyaratan_proposal_catatan_post')}}" enctype="multipart/form-data">
            @endif
                {{ csrf_field() }}
                <fieldset>
                    <input type="hidden" name="C_NPM" value="{{$nim}}">

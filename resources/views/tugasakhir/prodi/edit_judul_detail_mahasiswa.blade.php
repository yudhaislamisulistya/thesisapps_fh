...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- BEGIN DATA TABLE -->
        <div class="the-box">
            <form method="post" action="{{url('prodi/ubah_judul')}}/{{$data[0]->C_NPM}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <fieldset>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">Judul Topik</label>
                        <div class="col-lg-5">
                            <input type="text" class="form-control bold-border" name="topik" value="{{$data[0]->judul}}"/>
                        </div>
                    </div>
                    <br><br>
                    <div class="form-group">
